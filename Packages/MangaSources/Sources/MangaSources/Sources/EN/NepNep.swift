...
public class NepNepSource: MultiSource {    
    ...
    public func fetchMangaDetail(id: String) async throws -> SourceManga {
        ...
        return SourceManga(id: id, title: title, cover: cover, genres: genres, authors: authors, alternateNames: alternateNames, status: self.parseStatus(rawStatus), synopsis: synopsis, chapters: chapters, type: parseType(rawType))
    }
